...
const DetailDiskusiPengajar = () => {
    ...
    const getDaftarDiskusi = () => {
        ...
        fetch(`${process.env.REACT_APP_API}/listDiskusiPengajar`, {
            method: "POST",
    ...
    const handleTambahDiskusi = (e) => {
        ...
        fetch(`${process.env.REACT_APP_API}/tambahDiskusiPengajar`, {
            method: "POST",
            body: JSON.stringify(dataSend),
            headers: {
            "Content-Type": "application/json",
...
export default DetailDiskusiPengajar;